...
def generate_icse_test_cases_planner(src, tgt, path='.'):
    """
    ...
    for c in CONFIGS:
        for u in UTILITIES:
            ...
            if len(route) == 0:
                ...
                continue
            ploci = random.randint(1, len(route)-2)
            ploc = route[ploci]
            for a in range(1,MAX_RECONFIGS):
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-cost' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,True, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-nocost' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,False, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-cost-1' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,True, False, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-nocost-1' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,False,False, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-cost-fp' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,True, fix_path=True, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-nocost-fp' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,False, fix_path=True, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-cost-1-fp' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,True, False, fix_path=True, ploc=ploc)
                gen_planner_case('c', '%s-%s-%s-%s-%s-%s-%s-nocost-1-fp' %(c,perturbs,light_perturbs,src,tgt,u,a), path, c, perturbs, light_perturbs, src, tgt, u, route,a,False,False, fix_path=True, ploc=ploc)
...
def set_up_directories(path,id,case,start,ros = True):
...
def gen_planner_case(case, id, path, config, perturbs, light_perturbs, src, tgt, utility, route, num_adaptations=1,consider_cost=False,balanced_utility=True,fix_path=False, ploc=None):
    test_directory = set_up_directories(path, id, case, "params", False)
...
def gen_case(case,id, compose_file, path,config,perturbs,light_perturbs,src,tgt,utility,route,corridor,perturb_sleep,num_adaptations=1,consider_cost=False, balanced_utility=True, fix_path=False):
    ...
    test_directory = set_up_directories(path,id,case, "start")
    ...
    if args.planner_only:
        for m in range(args.machines):
            ...
            for i in range(args.num):
                generate_icse_test_cases_planner(tasks[0]['src'], tasks[0]['tgt'],path='icse-planner%s' %m)
                del tasks[0]
